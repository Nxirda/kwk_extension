...
TTS_CASE("Check for kwk::generate(out, func) 2D")
{
  ...
  int count = 0;
  kwk::generate("simd",[&](auto p1, auto p2)
  { 
    count++;
    return 10*p1+p2; 
  }
...
/* TTS_CASE("Check for kwk::generate(out, func) 3D")
{
  ...
  int count = 0;
  kwk::generate("simd", [&](auto p1, auto p2, auto p3)
  { 
    count++;
...
/* TTS_CASE("Check for kwk::generate(out, func) 4D")
{
  ...
  int count = 0;
  kwk::generate("simd", [&](auto p1, auto p2, auto p3, auto p4)
  { 
    count++;
